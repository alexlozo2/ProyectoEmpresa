	...
	public static void main(String[] args) {
		...
		do {
			...
			case 6:
				...
				empleados.stream()
				.filter(em -> em.getNombre().equals(nombreBusqueda))
				.forEach(em -> {System.out.println(em);});
				
				bandera = empleados.stream()
						  .anyMatch(em -> em.getNombre().equals(nombreBusqueda));
...
//				}
				...
				if(bandera != true) {
					System.out.println("No se encontro informacion del nombre "+nombre);
				}
			...
			case 7:
				...
				for(Empleados em: empleados) {
					...
					if(em.getNombre().equals(departamento)) {
						System.out.println(em);
						encontrado = true;
					}
				...
				if(encontrado != true) {
					System.out.println("No se encontro informacion del nombre "+departamento);
				}
